...
def content() -> str:
    ...
    tbl_Commands.add_row(['&#160;','skycommand(<command>,<value>)',QApplication.translate('HelpDlg','sends the raw TC4 <command>,<value> to the Skycommand (Cyberroaster) via BLE; <command> is an OT channel: OT1=burner, OT2=airflow, OT3=drum (e.g. skycommand(OT1,50))')]) ## SKYBLE ##
